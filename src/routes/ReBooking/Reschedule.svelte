...
>
  ...
  >
    ...
    <p class="text-center text-gray-500 text-lg mb-8 leading-relaxed">
      ...
      <span class="font-semibold text-blue-600">"ดำเนินการต่อ"</span>.
    </p>

    <!-- Ticket Info -->
    <div class="bg-gray-100 p-4 rounded-md mb-8">
      <p class="text-center text-lg text-gray-700 mb-1">
        หมายเลขตั๋วที่ต้องการเลื่อน
      </p>
    ...
    <!-- Date Picker -->
    <div class="mb-10">
      <label for="newDate" class="block text-lg font-medium text-gray-700 mb-2"
        >เลือกวันที่เดินทางใหม่:</label
      >
      <div class="relative">
        <input
          type="date"
