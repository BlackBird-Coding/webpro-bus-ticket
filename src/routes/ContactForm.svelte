<div class="container mx-auto p-16">
  <h1 class="text-5xl font-bold mb-10 text-center text-indigo-800">ติดต่อเรา</h1>
  
  <div class="bg-white p-12 rounded-lg shadow-xl transition-transform transform hover:scale-105 border border-gray-300">
    <p class="mb-8 text-gray-600 text-lg leading-relaxed">
      ท่านสามารถส่งข้อความถึงเราโดยใช้แบบฟอร์มส่งข้อความถึงเราหรือติดต่อช่องทางอื่นๆ ได้ดังนี้
    </p>
    
    <h2 class="text-3xl font-semibold mb-4 text-indigo-700 underline">บริการออนไลน์</h2>
