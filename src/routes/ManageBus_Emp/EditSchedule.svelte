  ...
  async function saveEdit() {
    ...
    if (result.isConfirmed) {
      try {
        ...
        console.error("SaveRoute error:", error);
        await Swal.fire("เกิดข้อผิดพลาด!", "ไม่สามารถบันทึกข้อมูลได้", "error");
      }
      ...
      <div class="border-b border-gray-900/10 pb-12">
            ...
            {#if isDisabled}
              <div>
                <h1 class="text-2xl font-semibold leading-7 text-gray-900">
                  <b>{tripdata.ScheduleCode}: {tripdata.ScheduleName}</b>
                </h1>
        ...
        {#if !isDisabled}
          <div class="sm:col-span-6">
            <label for="name" class="block text-base font-medium leading-6"
              >ชื่อเที่ยวรถ</label
            >
            <div class="mt-2">
              <input
            ...
            <div class="sm:col-span-6">
              ...
              <div class="mt-2">
                <select
                  ...
                  class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                >
                  <option value="">เลือกเส้นทางการเดินทาง</option>
                  {#each routes as data}
        ...
        <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-1 sm:grid-cols-4">
