...
<div class="m-10 mx-20">
  ...
  <div class="mt-5">
    ...
    <Table hoverable={true}>
        <TableHead class="bg-[#4F75FF] rounded-md py-2 text-lg text-center text-white">
        ...
        <TableBody>
            <TableBodyRow class="text-center">
              <TableBodyCell>06:30</TableBodyCell>
              <TableBodyCell>กรุงเทพฯ(หมอชิต2) - หาดใหญ่</TableBodyCell>
              <TableBodyCell>100</TableBodyCell>
              <TableBodyCell>300.00 บาท</TableBodyCell>
              <TableBodyCell>
                <Radio name="go"></Radio>
              </TableBodyCell>
            </TableBodyRow>
