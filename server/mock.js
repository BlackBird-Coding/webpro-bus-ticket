...
db.serialize(() => {
  ...
  db.run(
    `INSERT INTO Bookings (CustomerID, ScheduleID, BookingDate, SeatId, Status) VALUES
    (8, 1, '2024-10-10 10:00:00', 2, True),
    (9, 2, '2024-10-11 11:30:00', 4, True),
    (10, 3, '2024-10-09 09:15:00', 3, True),
    (11, 5, '2024-10-12 14:00:00', 1, False),
    (13, 5, '2024-10-10 16:45:00', 2, True),
    (14, 5, '2024-10-11 13:20:00', 3, True),
    (15, 5, '2024-10-09 10:30:00', 4, True),
    (16, 5, '2024-10-12 17:00:00', 5, False),
    (17, 5, '2024-10-10 15:15:00', 6, True),
    (17, 6, '2024-10-11 12:45:00', 1, True);`
  );
